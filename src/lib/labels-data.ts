...
export const CHAIN_COLORS: Record<string, string> = { eth: "#627eea", base: "#0052ff", arb: "#28a0f0", bsc: "#f0b90b", poly: "#8247e5", avax: "#e84142", hl: "#00d1b2", kaia: "#3fbb7a", sol: "#9945ff" };
export const CHAIN_KEYS = ["eth", "base", "arb", "bsc", "poly", "avax", "hl", "kaia", "sol"];
