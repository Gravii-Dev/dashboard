    ...
    <>
      ...
      <div className="grid-4">
        <DonutCard
          ...
          centerValue="1,124$"
          segments={[
            { color: "var(--chart-1)", value: 50 },
            { color: "var(--chart-2)", value: 30 },
            { color: "var(--chart-3)", value: 14 },
            { color: "var(--chart-4)", value: 6 },
          ]}
          legend={[
        ...
        <DonutCard
          ...
          centerValue="1,124$"
          segments={[
            { color: "var(--chart-5)", value: 40 },
            { color: "var(--chart-6)", value: 30 },
            { color: "var(--chart-1)", value: 20 },
            { color: "var(--chart-3)", value: 10 },
          ]}
          legend={[
        ...
        <DonutCard
          ...
          tooltip={TIV_TOOLTIP}
          segments={[
            { color: "var(--chart-2)", value: 45 },
            { color: "var(--chart-4)", value: 30 },
            { color: "var(--chart-1)", value: 16 },
        ...
        <DonutCard
          ...
          tooltip={TIV_TOOLTIP}
          segments={[
            { color: "var(--chart-3)", value: 40 },
            { color: "var(--chart-5)", value: 25 },
            { color: "var(--chart-2)", value: 20 },
